  ...
  return (
    <>
      <section className="container flex flex-col  gap-6 py-8 md:max-w-[64rem] md:py-12 lg:py-24">
        ...
        <div className="max-w-[85rem] px-4 py-2 sm:px-4 lg:px-5 lg:py-8 mx-auto">
          <div className="max-w-2xl mx-auto text-center mb-10 lg:mb-14">
            <h2 className="text-2xl font-bold md:text-6xl md:leading-tight dark:text-white">
              Meet the crew
            </h2>
            <p className="mt-2 leading-normal text-slate-700 sm:text-lg sm:leading-7 text-center">
              Creative people
            </p>
          </div>
