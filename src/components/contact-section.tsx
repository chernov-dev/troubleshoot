    ...
    <section className="container grid justify-center gap-6 py-8 md:py-12 lg:py-24">
        <div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
          <div className="max-w-2xl lg:max-w-5xl mx-auto">
            ...
            <div className="grid justify-center gap-8 sm:grid-cols-2 md:max-w-[56rem] mt-11">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div>
                        ...
                        <input
                          ...
                          className="py-3 px-4 block w-full border-gray-200 border-[1px] rounded-md text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400"
