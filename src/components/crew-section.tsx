...
const CrewSection = () => {
  return (
    <section className="container flex flex-col  gap-6 py-8 md:max-w-[64rem] md:py-12 lg:py-24">
        <div className="flex flex-col gap-4 w-full md:max-w-[52rem] mx-auto">
          <div className="max-w-2xl mb-2">
            ...
            Talented and experienced crew at Troubleshooting who are dedicated to providing fast and reliable computer repair and troubleshooting services to our customers
            </p>
          </div>
        ...
        <div className="mx-auto flex flex-col gap-4 md:max-w-[52rem]">
          <h2 className="text-2xl font-bold leading-[1.1] tracking-tighter sm:text-2xl md:text-4xl ">
            About us
          </h2>
          <p className="leading-normal text-slate-700 sm:text-lg sm:leading-7">
            ...
            about helping people solve their computer problems. With years of
            experience in the industry, we&apos;ve helped countless individuals
            and businesses get their technology back on track.
          </p>
        </div>
      </section>
  )
