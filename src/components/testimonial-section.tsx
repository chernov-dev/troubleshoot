...
const TestimonialSection = () => {
  return (
    ...
    >
      ...
      <Separator />
      <div className="mx-auto flex max-w-[78rem] flex-col md:flex-row items-center space-y-4 text-center">
        <div className="lg:col-span-5 lg:col-start-1">
          <div className="mb-8">
            ...
            <p className="leading-normal text-muted-foreground">
              ...
              help you get back to work or play as quickly as possible.
            </p>
          </div>
          <blockquote className="relative">
            <svg
              className="absolute top-0 left-0 w-16 h-16 transform -translate-x-6 -translate-y-8 "
              width="16"
              height="16"
              viewBox="0 0 16 16"
              fill="none"
        ...
        <div className="mt-10 lg:mt-0 lg:col-span-6 lg:col-end-13">
          <div className="space-y-6 sm:space-y-8">
            <ul className="grid grid-cols-2 overflow-hidden divide-x-2 divide-y-2 divide-gray-200 dark:divide-gray-700">
              <li className="flex flex-col -m-0.5 p-4 sm:p-8">
                <div className="flex items-end self-center mb-2 text-3xl font-bold gap-x-2 sm:text-5xl ">
                  45k+
                </div>
